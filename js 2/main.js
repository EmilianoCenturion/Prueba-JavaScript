...
let valor2 = "Hola"; // una cadena es un valor truthy
...
// Operador ternario: una forma mas compacta de escribir una condiciion if.. else

let edad3 = 20;
let mensaje = (edad3 >= 18) ? "Sos mayor de edad" : "Sos menor de edad" // el primero seria el if y el segundo seria el else 
...
// Ejemplo fro anidado con tabla de multiplicar 

for (let i = 1;i < 10; i++) {
    
    for (let j = 1;j <= 10; j++) {
        console.log(`La tabla del ${i} es: ${i} x ${j} = ${i * j}
        `)
    }
}
